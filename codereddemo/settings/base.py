"""
Django settings for codereddemo project.
...
if not os.path.exists(ENV_FILE):
    logger.error(f"Environment settings file missing: '{ENV_FILE}'")
else:
    logger.info(f"Loading local settings from: '{ENV_FILE}'")
...
WSGI_APPLICATION = "codereddemo.wsgi.application"
